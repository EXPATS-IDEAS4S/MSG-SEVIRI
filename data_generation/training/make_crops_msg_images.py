...
crops_path = '/work/dcorradi/crops/IR_108_2013-2014-2015-2016_200x200_EXPATS_fixed/nc/'

cma_path = '/work/dcorradi/crops/IR_108_2013-2014-2015-2016_200x200_EXPATS_fixed/nc_clouds/'

apply_cma = True
apply_closing = True

if apply_cma==False and apply_closing==True:
    print('closing can be applied only if cma is applied!')
    exit()

out_dir = f'/work/dcorradi/crops/IR_108_2013-2014-2015-2016_200x200_EXPATS_fixed/'
...
for norm_type in norm_types:
    ...
    for msg_crop, cma_crop in zip(crop_file_list, cma_file_list): 
        ...
        if apply_cma:
            ...
            if apply_closing:
                #apply binary colsing with a 3x3 structuring element
                structure = np.ones((3, 3), dtype=np.uint8)
                cloud_mask = binary_closing(cloud_mask, structure=structure)
